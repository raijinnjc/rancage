...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  {
    ...
    minRole: 'PUBLIC',
    description: 'Ringkasan tingkat tinggi indikator dan tren kemiskinan di Jawa Barat.',
  },
  {
    id: 'diagnosis',
    ...
    icon: 'TrendingUp',
    minRole: 'PUBLIC',
    description: 'Dekomposisi Indeks Theil dan diagnosis tren ketimpangan makro.',
  },
  {
    id: 'typology',
    ...
    icon: 'Grid',
    minRole: 'PUBLIC',
    description: 'Analisis kuadran Tipologi Klassen dan pemeringkatan prioritas kabupaten/kota.',
  },
  {
    id: 'regional-profile',
    ...
    icon: 'MapPin',
    minRole: 'PUBLIC',
    description: 'Analisis mendalam sosioekonomi dan radar deprivasi multi-dimensi.',
  },
  {
    id: 'household',
    ...
    icon: 'Users',
    minRole: 'GOVERNMENT',
    description: 'Pencarian mikrodata Proxy Means Testing (PMT) dan verifikasi target sasaran.',
  },
  {
    id: 'ml-evaluation',
    ...
    icon: 'Brain',
    minRole: 'GOVERNMENT',
    description: 'Audit akurasi model PMT Gradient Boosting, ambang batas, keadilan, dan tata kelola.',
  },
  {
    id: 'recommendation',
    ...
    icon: 'Briefcase',
    minRole: 'PUBLIC',
    description: 'Rekomendasi intervensi algoritmik dan simulasi alokasi fiskal.',
  },
  {
    id: 'monitoring',
